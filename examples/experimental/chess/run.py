...
The native Qwen 3.8 TITO family retains thinking and supports the user and
...
def _misc_args(args: ScriptArgs) -> str:
    ...
    return f"--attention-dropout 0.0 --hidden-dropout 0.0 --accumulate-allreduce-grads-in-fp32 --attention-softmax-in-fp32 --attention-backend flash --observe-training-entropy --log-multi-turn {placement_args}"
